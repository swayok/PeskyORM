...
abstract class FakeTableStructure extends TableStructure
{
     ...
     * @param \PeskyORM\ORM\TableStructure\TableStructureInterface|null $tableStructureToCopy - use this table structure as parent class for a fake one
     *      but replace its table name
     * @return \PeskyORM\ORM\TableStructure\TableStructureInterface
...
use PeskyORM\ORM\Fakes\FakeTableStructureHelpers;
