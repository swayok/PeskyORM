...
class IdColumn extends RealTableColumnAbstract
{
    ...
    public function setValue(RecordValueContainerInterface $currentValueContainer, mixed $newValue, bool $isFromDb, bool $trustDataReceivedFromDb): RecordValueContainerInterface
    {
        return parent::setValue($currentValueContainer, $newValue, $isFromDb, $trustDataReceivedFromDb); // TODO: Change the autogenerated stub
    }
