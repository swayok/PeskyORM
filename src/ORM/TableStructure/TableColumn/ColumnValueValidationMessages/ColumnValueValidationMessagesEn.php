...
class ColumnValueValidationMessagesEn implements ColumnValueValidationMessagesInterface
{
    protected array $messages = [
        ...
        self::VALUE_MUST_BE_JSON_OR_JSONABLE =>
            'Value must be a JSON-encoded string or an object that can be converted to JSON.',
        self::VALUE_MUST_BE_JSON_ARRAY_OR_OBJECT =>
        ...
        self::VALUE_MUST_BE_EMAIL => 'Value must be a valid E-mail address.',
        self::VALUE_MUST_BE_TIMEZONE =>
        ...
        self::VALUE_MUST_BE_TIMESTAMP_OR_INTEGER =>
            'Value must be a valid timestamp or positive integer (UNIX timestamp).',
        ...
        self::VALUE_FROM_DB_CANNOT_BE_QUERY_BUILDER =>
