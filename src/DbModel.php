...
abstract class DbModel {
    ...
    /** @var string */
    public $orderDirection = self::ORDER_ASCENDING;
    ...
    public $fields = array();
    /**
     * @var DbRelationConfig[] = array('alias' => DbRelationConfig)
     */
    ...
    public function loadTableConfig($modelName) {
        ...
        $this->tableConfig = new $this->configClass();
        $this->fields = $this->tableConfig->getColumns();
        $this->relations = $this->tableConfig->getRelations();
    }
    ...
    public function getRelatedModel($alias) {
        ...
        $relatedModelClass = self::getFullModelClassByTableName($this->relations[$alias]->getForeignTable());
        if (!class_exists($relatedModelClass)) {
            throw new DbModelException($this, "Related model class [{$relatedModelClass}] not found for relation [{$alias}]");
        }
        return $this->getModel(self::getModeNameByTableName($this->relations[$alias]->getForeignTable()));
    }
