...
ALTER TABLE "public"."admins" ADD UNIQUE ("email");
ALTER TABLE "public"."admins" ADD UNIQUE ("login");
...
ALTER TABLE "public"."info_pages" ADD PRIMARY KEY ("id");

-- --------------------------------------------------------

CREATE UNIQUE INDEX "settings_key_idx" ON "public"."settings" USING btree ("key");
ALTER TABLE "public"."settings" ADD UNIQUE ("key");
